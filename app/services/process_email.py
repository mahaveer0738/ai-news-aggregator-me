...
def generate_email_digest(hours: int = 1000, top_n: int = 10) -> EmailDigestResponse:
...
def send_digest_email(hours: int = 1000, top_n: int = 10) -> dict:
    try:
...
if __name__ == "__main__":
    result = send_digest_email(hours=1000, top_n=10)
    if result["success"]:
        print("\n=== Email Digest Sent ===")
